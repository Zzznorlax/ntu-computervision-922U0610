...
### Description
In this homework, a program that can be used to detect edge with following threshold is implemented
...
|                                    |                                     |
| ---------------------------------- | ----------------------------------- |
| (a)![Alt text](assets/robert.jpg)  | (b)![Alt text](assets/prewitt.jpg)  |
| (c)![Alt text](assets/sobel.jpg)   | (d)![Alt text](assets/frei.jpg)     |
| (e)![Alt text](assets/kirsch.jpg)  | (f)![Alt text](assets/robinson.jpg) |
| (g)![Alt text](assets/nevatia.jpg) |                                     |


### Implementation
First perform edge detection then binarize the outputs with given thresholds.
```python
    if op == "robert":
        img = robert(img)
